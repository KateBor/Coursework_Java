...
public class InitiateUtils implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        //Request 3
        warehouse1Service.addGoodsToWarehouse1(new WarehouseCreationRequest(startGoodId + 1, 15));
        warehouse1Service.addGoodsToWarehouse1(new WarehouseCreationRequest(startGoodId + 3, 10));
        warehouse1Service.addGoodsToWarehouse1(new WarehouseCreationRequest(startGoodId + 6, 7));
        warehouse1Service.addGoodsToWarehouse1(new WarehouseCreationRequest(startGoodId + 9, 2));
        long startWarehouse1Id = warehouse1Service.listWarehouse1().get(0).getId();


        //Request 4
        warehouse2Service.addGoodsToWarehouse2(new WarehouseCreationRequest(startGoodId + 1, 4));
        warehouse2Service.addGoodsToWarehouse2(new WarehouseCreationRequest(startGoodId + 2, 17));
        warehouse2Service.addGoodsToWarehouse2(new WarehouseCreationRequest(startGoodId + 5, 9));
        warehouse2Service.addGoodsToWarehouse2(new WarehouseCreationRequest(startGoodId + 8, 12));
...
//        }
        ...
        salesService.findSaleByGood_id(startGoodId + 1);
